namespace Cumulocity.SDK.Client.Rest.Representation.Builder
{
    public class RestRepresentationObjectBuilder
    {
		...
		//        {
		//            return new RetentionRuleCollectionRepresentationBuilder();
		//        }
		//
		//        public static RetentionRuleRepresentationBuilder aRetentionRuleRepresentation()
		//        {
		//            return new RetentionRuleRepresentationBuilder();
		//        }
		//
		//        public static BulkOperationRepresentationBuilder aBulkOperationRepresentation()
		//        {
		//            return BulkOperationRepresentationBuilder.builder();
		//        }
		//
		//        public static OperationRepresentationBuilder anOperationRepresentation()
		//        {
