...
namespace Cumulocity.SDK.Client.Rest.Representation
{
    public class AbstractExtensibleRepresentation : BaseResourceRepresentation 
    {
	    ...
	    //ORIGINAL LINE: @JSONProperty(ignore = true) public <T> void set(Object object, Class<T> clazz)
	    ...
	    /// </param>
//JAVA TO C#  TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unchecked") public <T> T get(Class<T> clazz)
