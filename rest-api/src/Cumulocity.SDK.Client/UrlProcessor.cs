...
public class UrlProcessor
{
    ...
    //ORIGINAL LINE: public String removeQueryParam(String url, Collection<String> params) throws SDKException
    ...
    //ORIGINAL LINE: public String replaceOrAddQueryParam(String url, Map<String, String> newParams) throws SDKException
