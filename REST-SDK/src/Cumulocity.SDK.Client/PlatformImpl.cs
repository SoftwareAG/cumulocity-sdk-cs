...
{
	public class PlatformImpl : PlatformParameters, IPlatform
	{
		...
		public IUserApi UserApi
		{
			...
			{
				var restConnector = createRestConnector();
				return new UserApiImpl(restConnector, new TemplateUrlParser(), getPlatformApi(restConnector).User);
			}
		}
